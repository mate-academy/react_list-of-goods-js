...
1. `Reverse` button changes the current order to the opposite one.
    - it should work together with any sorting;тзь
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://NikolaienkoN.github.io/react_list-of-goods-js/) and add it to the PR description.
