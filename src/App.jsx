...
export function App() {
  ...
  const sortAlphabetically = () => {
    const copy = [...goodsFromServer].sort((a, b) => a.localeCompare(b));
    setGoodsCopy(copy);
  ...
  return (
    <div className="section content">
      <div className="buttons">
        <button
          type="button"
          className={`button is-info ${lastChange === 'alphabetic' || lastChange === 'reverse-alphabetic' ? '' : 'is-light'}`}
          onClick={() => {
            sortAlphabetically();
          }}
        >
        ...
        <button
          type="button"
          className={`button is-info ${lastChange === 'length' || lastChange === 'reverse-length' ? '' : 'is-light'}`}
          onClick={() => {
            sortByLength();
          }}
        >
