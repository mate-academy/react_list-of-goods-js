...
const SORT_FIELD_REVERSE = 'reset';

function getPreparedGoods(goods, { sortField, sortFieldReverse }) {
  ...
  return (
    <div className="section content">
      <div className="buttons">
        ...
        <button
          type="button"
          className={`button is-info ${cn({ 'is-light': sortFieldReverse !== SORT_FIELD_REVERSE })}`}
          onClick={() => {
            if (sortFieldReverse === SORT_FIELD_REVERSE) {
              setSortFieldReverse('');
            } else {
